...
<head>
    <title>Vocational & Skills Training | Barrizi Organisation</title>
    <style>
        body {
            padding-top: 0;
        ...
        .brz-page-header::before {
            ...
            position: absolute;
            inset: 0;
            background-image: url('assets/new/sew.jpg');
    ...
    <main>
        ...
        <section class="brz-page-header">
            <div class="container brz-page-header__content">
                <h1 class="brz-page-header__title brz-observe slide-up">Vocational & Skills Training</h1>
                <div class="brz-page-header__breadcrumb brz-observe slide-up anim-delay-1">
                    <a href='index.php'>Home</a> / <a href='program.php'>Programs</a> / Vocational Training
                </div>
            </div>
        </section>
                    ...
                    <div class="col-lg-8 mb-5 mb-lg-0 brz-observe slide-right">
                        ...
                        <div class="brz-about-img-stack position-relative" style="padding:30px; margin-bottom:40px;">
                            ...
                            <div class="brz-polaroid brz-polaroid-main"
                                ...
                                <img src="assets/new/sew.jpg" alt="Program"
                            ...
                            <div class="brz-polaroid"
                                ...
                                <img src="assets/new/sew2.jpg" alt="Program Details"
                        ...
                        <div class="program-text">
                            Formal academic education is not the only pathway to success. For many older teens and young
                            adults in Dandora who missed out on secondary education, acquiring a tangible, marketable
                            trade is the fastest route to financial independence. Our Vocational and Skills Training
                            program equips these individuals with practical expertise, instantly transforming them from
                            vulnerable dependents into skilled professionals.<br><br>We offer intensive, 6-to-12-month
                            training courses aligned with the local job market demands. From tailoring and catering to
                            computer literacy and artisan development, we provide the tools, the teachers, and the
                            startup knowledge required to break the cycle of poverty and build a self-sustaining future.
                        </div>
                        ...
                        <ul class="brz-check-list"
                            ...
                            <li><i class="fas fa-check-circle"></i> Tailoring & Dressmaking: Comprehensive training in
                                garment construction, design, and machine operation.</li>
                            <li><i class="fas fa-check-circle"></i> Catering & Hospitality: Hands-on culinary skills,
                                food safety, and event catering management.</li>
                            <li><i class="fas fa-check-circle"></i> Hairdressing & Beauty: Practical skills in salon
                                services, preparing trainees for immediate employment in the local beauty industry.</li>
                            <li><i class="fas fa-check-circle"></i> Computer Skills: Essential digital literacy, office
                                software training, and basic IT skills.</li>
                            <li><i class="fas fa-check-circle"></i> Artisan Development: Cultivating talents in music,
                                arts, and crafts for commercial viability.</li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-4 brz-observe slide-left">
                        ...
                        <div class="sidebar-card">
                            ...
                            <ul class="prog-info-list">
                                <li><i class="fas fa-tags"></i> <strong>Category:</strong> Skills & Employment</li>
                                <li><i class="fas fa-users"></i> <strong>Target Group:</strong> Out-of-school Youth &
                                    Teens</li>
                        ...
                        <div class="sidebar-card contact-cta-box">
                            ...
                            <p style="font-size:0.95rem; color:var(--text-muted); margin-bottom:20px;">Contact us to
                                learn more about Vocational & Skills Training or to get involved.</p>
                    ...
                    <div class="col-12 brz-observe slide-up">
                        ...
                        <div class="goal-cards-wrapper">
                            <div class="goal-card short-term">
                                ...
                                <ul>
                                    <li><i class="fas fa-bullseye"></i> Equip out-of-school youth with highly practical,
                                        income-generating skills within 6 to 12 months.</li>
                                    <li><i class="fas fa-bullseye"></i> Provide all necessary training materials (sewing
                                        machines, ingredients, salon tools) so trainees incur no costs.</li>
                                    <li><i class="fas fa-bullseye"></i> Foster an entrepreneurial mindset alongside
                            ...
                            <div class="goal-card long-term">
                                ...
                                <ul>
                                    <li><i class="fas fa-rocket"></i> Facilitate direct job placements or business
                                        startups for 100% of our vocational graduates.</li>
                                    <li><i class="fas fa-rocket"></i> Reduce youth unemployment and associated crime
                                        rates in the Dandora community.</li>
                                    <li><i class="fas fa-rocket"></i> Establish a Barrizi-run community enterprise where
                                        graduates can work and sell their products.</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="impact-box">
                            <ul class="brz-check-list">
                                <li><i class="fas fa-check-circle"></i> 15 highly vulnerable teens successfully enrolled
                                    in and progressing through our 6-12 month vocational training courses.</li>
                                <li><i class="fas fa-check-circle"></i> Graduates are actively establishing their own
                                    micro-businesses in the community.</li>
                                <li><i class="fas fa-check-circle"></i> Restored dignity and provided a clear,
                                    actionable pathway out of poverty for youth who had lost hope.</li>
                            </ul>
                        </div>
                        ...
                        <div class="help-box">
                            <ul class="brz-check-list">
                                <li><i class="fas fa-heart"></i> Donate Equipment: We are always in need of working
                                    sewing machines, laptops, and salon equipment.</li>
                                <li><i class="fas fa-heart"></i> Fund a Trainee: A one-off donation can sponsor a
                                    vulnerable teen through a full 6-month certification course.</li>
                                <li><i class="fas fa-heart"></i> Hire our Graduates: Partner with us to provide
                                    internship or employment opportunities for our skilled youth.</li>
                            </ul>
                        </div>
